# Carousel CSS Scroll Snap Optimization

## Description
This PR adds CSS Scroll Snap support to the `carousel` component, enabling precise hardware-accelerated scroll-stopping at component boundaries. It uses `scroll-snap-type: x mandatory`, `scroll-snap-align: start`, and `scroll-snap-stop: always` to deliver a native app-like scrolling experience without any JavaScript.
