# Form CSS Logical Properties

## Description
This PR migrates the `form` component from physical CSS properties (`margin-left`, `padding-right`, `border-left`) to CSS Logical Properties (`margin-inline-start`, `padding-inline-end`, `border-inline-start`). This ensures the component automatically adapts to both LTR and RTL writing modes without requiring any manual overrides using `[dir="rtl"]` selectors.
